...
WSGI_APPLICATION = "soltyback.wsgi.application"

#ASGI_APPLICATION = "soltyback.asgi.application"
...
OA_TOKEN_URL = os.getenv("OA_TOKEN_URL", "https://api.privy.io/v1/authenticate")
OA_CLIENT_ID = os.getenv("OA_CLIENT_ID", None)
OA_SECRET = os.getenv("OA_SECRET", None)
OA_REDIR_URL = os.getenv("OA_REDIR_URL", "")
